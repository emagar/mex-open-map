...
\author{E.~Magar\footnote{Corresponding author: \url{emagar@itam.mx}.  We describe contributions to the paper using a standard taxonomy \citet{allen2014credit}. E. Magar (EM) and A. Trelles (AT) were lead authors, having taken primary responsibility for writing. EM prepared the original draft. M. Altman (MA) and M. McDonald (MM) contributed to writing through editing and review. All authors shared contributed equally to conceptualization. EM lead methodology, with contributions from MM. AT lead data curation, with contributions from EM.   } \\ \emph{ITAM} \and
