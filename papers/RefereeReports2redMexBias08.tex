...
\item More elements for our response: Regarding multipartism, Calvo and Micozzi show that increasing party competition pulls the votes-seats curve leftward (fig. 1-c). This is precisely what partisan bias achieves---for a favored party only: a more efficient votes to seats conversion. Bias produces a \emph{rightward} shift for unfavored parties: a \emph{less} efficient votes to seats conversion. So whereas the effect of multipartism remains symmetric (absent bias, all parties get a seat bonus by reaching much less than 50 percent), partisan bias remains asymmetric. We have added a footnote at the end of section 1 to elaborate this.
\end{itemize}
