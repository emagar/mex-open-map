...
%Alejandro: The first sentence of the abstract "The 1997 electoral reform rid Mexico of the most flagrant distortions on representation" seemed a bit out of context for the broader audience and disconected from the rest of the abstact, so I took it out and replaced it with Mexcio´s automated redisticting context. 
