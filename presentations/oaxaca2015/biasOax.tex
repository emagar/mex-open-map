...
\institute[ITAM-Pitt-MIT-UFG]{\inst{1} ITAM \and 
                              ...
                              \inst{4} UF}
%\address{}
\date[28jul15]{CMO--BIRS Pol.~Econ.~of Social Choices, Oaxaca \\ 7/28/15}
...
Procedures exist, but limited to (exceptional) two-party competition

\pause

\begin{block}{Contributions}
\begin{enumerate}
\item Extention to multi-party competition
...
Key quantity of interest is the system's \textbf{partisan bias} = undue advantage coferred to some party in the conversion of votes into seats

\begin{itemize}
\item Potential distortion wherever districts are drawn to allocate seats (Tufte 1973, Johnston 2002)
\end{itemize}
...
\begin{enumerate}
\item Gerrymanders (Cox\&Katz 2002)
\item Turnout differentials (Rosenstone\&Hansen 1993)
\item Malapportionment and demographic shifts (Jackman 1994)
\end{enumerate}
% (Grofman et al.\ 1997)
...
Procedure to break down three sources in two-party competition (cf.\ Grofman~et~al.~1987)
...
\begin{itemize}
\item Two-party system assumed
\item .5 threshold unappropriate for multi-party (or imbalanced) competition 
\item Alternative threshold not evident: relative quantity better
...
Fit equation above using $v$, then $\bar{v}$, then $\bar{w}$; \\ rely on subtraction formulas to get measures of partisan bias and its components
...
\item Multi-year approach: pool historic record... compares apples/oranges in long-haul
\item Single-election apprach preferable... but requires data multiplication strategy 
\end{itemize}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {                      % SLIDE
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\frame{                      % SLIDE
    \frametitle{One person--one vote?}

Malapportionment --definition
When more densely-populated regions get the same representation as the less densely populated

Can arise by comission or by omission
