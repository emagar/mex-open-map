...
#
wd <- c("/home/eric/Dropbox/data/elecs/MXelsCalendGovt/redistrict/git-repo/mex-open-map/replicationFiles/code/") # set your working directory here
setwd(wd)
dd <- c("../data/")   # data directory
gd <- c("../graphs/") # graph data directory
...
summary(swRats)
## uncomment next line if you wish to overwrite distributed results 
