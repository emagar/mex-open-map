...
library(dplyr)
library(tidyr)
tmpdf<-gather(subset(INE2013s1.df,select=-CNV.Recomendacion),key="key",value="value",-Entidad)
...
Sample analysis crosstab, viz
```{r}
results<-xtabs(formula=proposed~actor+govlevel,data=tmpdf2)
print(results)
