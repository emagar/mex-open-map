...
require(car)
require(MASS)
>>>>>>> e019b23c88b35d54eb688b3dfe97a12d4a6497c7
=======
require(lmtest)
require(car)
>>>>>>> 8c91567e41dde435934cc5a957b8a9e613ad0d42
```
...
table(prop.H1.df$StratPos)
check.df <- prop.H1.df %>% filter(StratPos == 6)
table(check.df$edon)
...
Mod.3 <- prop.H1.df %>% glm(PROPOSED ~ as.factor(StratPos) + as.factor(year) + as.factor(govlevel), data=., family = binomial)
