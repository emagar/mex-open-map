...
#Sum votes across seccion; aggregated at the state level
Vraw.2018 %<>% mutate(year = 2018)
...
Vraw.2018 %<>% na.omit() %>%
  ...
  summarise(., votes.2018 = sum(votes.2018),
            ...
            dpanc = sum(dpanc),
            dpric = sum(dpric),
            dmorenac = sum(dmorenac)) %>%
    mutate(VoteShare.2018 = (votes.2018/efec)*100)
...
#Generate values for vote share by actor
Vraw.2015 %<>% mutate(VoteShare.2015 = (votes.2015/efec)*100)
...
Vraw.2015 %>% 
  ...
  summarise(., sum(Rentability)) %>%
  gt() %>%
  cols_label("actor" = "Party", "Rentability" = "Seccion Scores")
```
```{r}

#Sum votes across seccion; aggregated at the state level
Vraw.2012 %<>% mutate(year = 2012)
...
#Generate values for vote share by actor
Vraw.2012 %<>% mutate(VoteShare.2012 = (votes.2012/efec)*100) 
...
#Generate values for vote share by actor
Vraw.2009 %<>% mutate(VoteShare.2009 = (votes.2009/efec)*100) 
...
#Generate values for vote share by actor
Vraw.2006 %<>% mutate(VoteShare.2006 = (votes.2006/efec)*100) 
...
#Generate values for vote share by actor
Vraw.2003 %<>% mutate(VoteShare.2003 = (votes.2003/efec)*100) 
...
#Generate values for vote share by actor
Vraw.2000 %<>% mutate(VoteShare.2000 = (votes.2000/efec)*100) 
