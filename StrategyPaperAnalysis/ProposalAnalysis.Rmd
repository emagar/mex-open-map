...
partytype.df$partytype[partytype.df$actor == "CLV" | partytype.df$actor == "Algorithm" | partytype.df$actor == "Junta" | partytype.df$actor == "INE"] <- "admin"
partytype.df$partytype[partytype.df$actor == "PRD51"] <- "other"
