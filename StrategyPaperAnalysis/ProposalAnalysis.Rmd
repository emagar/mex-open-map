...
#Extremely rentable >90%
#Rentabble >50%
#Moderately Rentable >30%
#Weakly Rentable <30%

#Pass through function that calculates the expected votes by state by district by seccion by party based on VHAT estimators

#Rentability groupings

#Create those categories you had mentioned alejandro (safe, competitive, ) STRATEGY PAPER p100; rentability of the DISTRICT; reference vhat predictions to develop indv actor strategy
