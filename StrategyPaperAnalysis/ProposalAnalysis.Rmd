...
PRD, PAN, PRI are considered major parties, while all other parties are considered "minor."
CLV and Algorithm are included as actors, still unsure of how to categorize them.
```{r}
